...
webscrapedDataFile = "csvjson.json"  
...
for i in range(start,stop):
    ...
    if cost == "No":
        cost = ["This is a free competition", False, 0]
    else:
        cost = ["This competition costs money to apply",True, "unknown"]
    activity = {
        "title": title,
        "text": text,
        "tags": [],
    ...
    with open("snowDayCompetitions.json", "w") as f:
